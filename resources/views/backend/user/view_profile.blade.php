                ...
                <div class="col-12">
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-header bg-black">
                            <h3 class="widget-user-username">User Name : {{ucfirst($user->name)}}</h3>
                            <a href="{{route('profile.edit')}}" class="btn btn-rounded btn-success mb-5 pull-right">Edit Profile</a>
